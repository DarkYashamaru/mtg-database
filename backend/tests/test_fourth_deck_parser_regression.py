...
DECKLIST_PATH = Path(__file__).with_name("test_fourth_decklist.txt")
...
class FourthDeckParserRegressionTest(unittest.TestCase):
    maxDiff = None
    ...
    def test_fourth_deck_cards_have_no_custom_nodes(self) -> None:
        missing: list[str] = []
        failures: list[str] = []
