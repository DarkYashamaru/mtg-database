...
DECKLIST_PATH = Path(__file__).with_name("test_main_decklist.txt")
...
class MainDeckParserRegressionTest(unittest.TestCase):
    maxDiff = None
    ...
    def test_main_deck_cards_have_no_custom_nodes(self) -> None:
        missing: list[str] = []
        failures: list[str] = []
