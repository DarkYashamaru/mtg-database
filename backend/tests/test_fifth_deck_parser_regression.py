...
DECKLIST_PATH = Path(__file__).with_name("test_fifth_decklist.txt")
...
class FifthDeckParserRegressionTest(unittest.TestCase):
    maxDiff = None
    ...
    def test_fifth_deck_cards_have_no_custom_nodes(self) -> None:
        missing: list[str] = []
        failures: list[str] = []
