...
DECKLIST_PATH = Path(__file__).with_name("test_second_decklist.txt")
...
class SecondDeckParserRegressionTest(unittest.TestCase):
    maxDiff = None
    ...
    def test_second_deck_cards_have_no_custom_nodes(self) -> None:
        missing: list[str] = []
        failures: list[str] = []
